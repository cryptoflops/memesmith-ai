...
module.exports = {
  solidity: {
    ...
    settings: {
      ...
      viaIR: true, // 👈 enables the new IR pipeline (fixes “stack too deep”)
    },
  },
  networks: {
    celoSepolia: {
  ...
  // Sourcify verification (optional but recommended)
  sourcify: {
    enabled: false, // Set to true if you want to use Sourcify
  },
};